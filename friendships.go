...
func (api *APIClient) GET_friendships_friends(params map[string]interface{}, result *Friendships) error {
	return api.get.call("friendships/friends", params, result)
}

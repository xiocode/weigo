...
func (api *APIClient) POST_suggestions_users_not_interested(params map[string]interface{}, result *User) error {
	return api.post.call("suggestions/users/not_interested", params, result)
}
